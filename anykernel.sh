...
# begin properties
properties() { '
kernel.string=Nightmare x Begonia Kernel by Hoshi
do.devicecheck=1
do.modules=0
do.systemless=1
do.cleanup=1
...
if isTimRom; then
    ...
    ui_print " » Create a Nightmare on Your Device...";
    ...
    ui_print " » Creating a Nightmare on Your Device ....";
    ...
    ui_print " » This Would Be A Nightmare....";
